...
var Opa = function () {
    ...
    (0, _createClass3.default)(Opa, [{
        ...
        key: 'appear',
        value: async function appear() {
            var _this = this;

            if (this.after) {
                return this.after.appear().then(function () {
        ...
        key: 'appearNow',
        value: async function appearNow() {
            var _this2 = this;
            ...
            return elementLoaded(this.item).then(function () {
...
async function runAppear(item) {
    ...
    return timeout(500, item).then(function (item) {
...
async function opaAppear(item) {
    if (item.dataset.opaAppeared) return _promise2.default.resolve(item);
    if (item.classList.contains('opa--visible')) return _promise2.default.resolve(item);
...
async function elementLoaded(element) {
    return isImageLoaded(element) ? _promise2.default.resolve(element) : new _promise2.default(function (resolve) {
...
async function timeout(time) {
    ...
    return new _promise2.default(function (resolve) {
        setTimeout.apply(undefined, [resolve, time].concat(args));
    });
}
