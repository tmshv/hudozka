...
var runAppear = function () {
    ...
    return function runAppear(_x) {
        return _ref3.apply(this, arguments);
    };
}();

var opaAppear = function () {
    var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(item) {
        return _regenerator2.default.wrap(function _callee4$(_context4) {
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        if (!item.dataset.opaAppeared) {
                            _context4.next = 2;
                            break;
                        }

                        return _context4.abrupt('return', _promise2.default.resolve(item));

                    case 2:
                        if (!item.classList.contains('opa--visible')) {
                            _context4.next = 4;
                            break;
                        }
    ...
    return function opaAppear(_x2) {
        return _ref4.apply(this, arguments);
    };
}();

var elementLoaded = function () {
    var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(element) {
        return _regenerator2.default.wrap(function _callee5$(_context5) {
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        return _context5.abrupt('return', isImageLoaded(element) ? _promise2.default.resolve(element) : new _promise2.default(function (resolve) {
    ...
    return function elementLoaded(_x3) {
        return _ref5.apply(this, arguments);
    };
}();

var timeout = function () {
    var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(time) {
                ...
                switch (_context6.prev = _context6.next) {
                    case 0:
                        return _context6.abrupt('return', new _promise2.default(function (resolve) {
                            setTimeout.apply(undefined, [resolve, time].concat((0, _toConsumableArray3.default)(args)));
                        }));
...
var Opa = function () {
    function Opa(item) {
        (0, _classCallCheck3.default)(this, Opa);
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                return _context.abrupt('return', this.after.appear().then(function () {
                                    return timeout(_this.delay);
                                }).then(function () {
                                    return _this.appearNow();
                                }));

                            case 4:
                                return _context.abrupt('return', this.appearNow());
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                return _context2.abrupt('return', this.__appear);

                            case 3:

                                this.__appear = opaAppear(this.item).then(function (item) {
                                    return _this2.__clear();
                                });
                                return _context2.abrupt('return', this.__appear);

                            case 5:
                                return _context2.abrupt('return', elementLoaded(this.item).then(function () {
                                    _this2.isLoaded = true;
                                    return _this2.appearNow();
                                }));
...
function initOpaGroup(items) {
    return items.map(function (item) {
        ...
        return prev ? item.appearAfter(prev) : item;
    }).map(function (x) {
        return x.appear();
    });
}
