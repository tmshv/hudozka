...
- [ ] **Step 1: Create shared MarkdownManager factory**
...
- [ ] **Step 2: Rewrite textBlockToTiptap to use markdown parsing**
...
- [ ] **Step 3: Rewrite text serialization to use markdown output**
